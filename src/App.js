...
const Socials = () => {
  ...
  const links = [
    "https://t.me/hakkafinance",
    "https://discord.com/invite/zYfqpUQ",
    "https://twitter.com/hakkafinance",
    "https://medium.com/hakkafinance",
    "https://github.com/hakkafinance",
  ];
  return (
      ...
      <div className="card">
        ...
        <a href={props.productLink}>
          <svg
            ...
            viewBox="0 0 44 44"
            style={{ float: "right" }}
            onMouseOver={() => setColor("#29d646")}
            onMouseOut={() => setColor("#169150")}
          >
...
const CurrentProducts = () => {
  return (
    <CardDeck>
      <Card
        title="BlackholeSwap"
        whitepaperLink="http://google.com/"
        desc="HA decentralized AMM (Automatic Market Making) exchange designed for stablecoins"
        productLink="http://google.com/"
      />
      <Card
        title="BlackholeSwap"
        whitepaperLink="http://google.com/"
  ...
  return (
    <>
      ...
      <footer className="copyright">
        <p>© Copyright 2021 HAKKA FINANCE</p>
      </footer>
    </>
  );
};
